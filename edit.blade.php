...
@section('content')
    {!! Form::model($webshop,['route' => ['admin.webshop.webshop.update', $webshop->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane {{ App::getLocale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                        @include('webshop::admin.webshops.partials.edit-fields', ['lang' => $locale])
                    </div>
                    <?php endforeach; ?>
